...
Route::middleware(['web', 'auth'])->group(function () {
    ...
    Route::post('/dragonzap/two_factor/confirm_totp', 'Dragonzap\TwoFactorAuthentication\Controllers\TwoFactorAuthenticationController@twoFactorEnterTotpCodeSubmit')->name('dragonzap.two_factor_confirm_totp_code');
});